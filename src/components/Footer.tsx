          ...
          <div className="grid md:grid-cols-3 gap-10 md:gap-8">
            ...
            <div>
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <a href="https://t.me/imbim_bot" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-forest text-sm transition-colors duration-300 no-underline">Telegram: t.me/imbim_bot</a>
              </div>
            </div>
          </div>
